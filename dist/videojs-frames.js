...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.videojsFrames = factory(global.videojs));
  ...
  videojs__default["default"].registerComponent('ClippingBar', ClippingBar);
  ...
  const MAGIC_NUMBER = new Uint8Array(['0x89', '0x42', '0x49', '0x46', '0x0d', '0x0a', '0x1a', '0x0a']);
  ...
  class BIFParser {
    ...
    generateBIFIndex() {
      ...
      let i = 0, bifIndexEntryOffset = BIF_INDEX_OFFSET; i < this.numberOfBIFImages; i += 1, bifIndexEntryOffset += BIF_INDEX_ENTRY_LENGTH) {
  ...
  const VjsMouseTimeDisplay = videojs__default["default"].getComponent('MouseTimeDisplay');
   ...
   */
  class BIFMouseTimeDisplay extends VjsMouseTimeDisplay {
    /**
       * Create BIF element.
       *
    ...
    /**
       ...
       */
    configure(options) {
      this.options_ = videojs__default["default"].obj.merge(defaults$1, this.options_, options);
      const {
        data
      } = options;
    ...
    getCurrentTimeAtEvent(event) {
      ...
      const position = getPointerPosition(event, seekBar.el());
    ...
    handleSliderMove(data) {
      ...
      if (videojs__default["default"](this.player().id()).hasClass('video-is-dragging')) {
    ...
    handleProgressBarMove(event, parent) {
      ...
      this.BIFTime.innerHTML = videojs__default["default"].time.formatTime(Math.floor(time));
    }
  ...
  videojs__default["default"].registerComponent('BIFMouseTimeDisplay', BIFMouseTimeDisplay);
  const VjsSeekBar = videojs__default["default"].getComponent('SeekBar');
  ...
  */
  ...
  class Frames extends Plugin {
    ...
    initBif() {
      ...
      const {
        BIFMouseTimeDisplay
      } = this.player.controlBar.progressControl.seekBar;
    ...
    createTimeDisplay() {
      ...
      videojs__default["default"].registerComponent('TimeDisplay', TimeDisplay);
    ...
    createTimecodeMenu() {
      ...
      videojs__default["default"].registerComponent('TimecodeButton', TimecodeButton);
    ...
    createClippingMenu() {
      ...
      videojs__default["default"].registerComponent('ClipButton', ClipButton);
    ...
    initClippingUi() {
      ...
      nouislider.exports.create(slider, {
  ...
  videojs__default["default"].registerPlugin('frames', Frames);
